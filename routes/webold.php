...
Route::prefix('app')
    ...
    ->group(function () {
        ...
        Route::put('/competition/{id}', 'AdminController@update'); //change on prod
...
Route::prefix('client')
    ...
    ->group(function () {
        ...
        Route::put('/competition/{id}', 'CompetitionController@update'); //change prod
        Route::get('/competition', 'CompetitionController@show');
        Route::delete('/competition/{id}', 'CompetitionController@delete'); //change prod

        Route::post('/player', 'PlayerController@create');
        Route::get('/player', 'PlayerController@show');
        Route::put('/player/{id}', 'PlayerController@update'); //change prod
        Route::delete('/player/{id}', 'PlayerController@delete'); //change prod

        Route::post('/official', 'OfficialController@create');
        Route::get('/official', 'OfficialController@show');
        Route::put('/official/{id}', 'OfficialController@update'); //change prod
        Route::delete('/official/{id}', 'OfficialController@delete'); //change prod

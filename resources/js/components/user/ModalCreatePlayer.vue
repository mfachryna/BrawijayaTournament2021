    ...
    >
        <Form ref="form" :model="data" :rules="formRules" class="form__">
            <div class="left">
                ...
                <FormItem v-if="comptt_name == 'ml' || comptt_name == 'pubg'|| comptt_name == 'valorant'" prop="handphone">
                ...
                <FormItem v-if="comptt_name == 'ml' || comptt_name == 'pubg' || comptt_name == 'valorant'" prop="game_id">
                    <Input
                        v-model="data.game_id"
                        :placeholder="comptt_name== 'ml'? 'Server ID': 'ID/Username' "
                    />
                </FormItem>
                <FormItem v-if="comptt_name == 'ml' || comptt_name == 'pubg' || comptt_name == 'valorant'" prop="posisi">

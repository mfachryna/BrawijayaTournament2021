<template>
    <Modal
        v-model="modalState"
        title="Daftar Tim Mobile Legends SMA/MA"
        :closable="false"
        :mask-closable="false"
        width="600"
...
<script>
import univ from "../../config/highSchool";
        ...
        return {
            ...
            formRules: {
                ...
                university: [
                    {
                        required: true,
                        message: "Please fill in the High School Name Name",
                        trigger: "blur",
                    },
                ],
            },
    ...
    methods: {
        async createData() {
            ...
            if (res.status == 200) {
                ...
                this.resetForm();
                this.$router.push("/dashboard/mobile-legends-sma");
            } else {

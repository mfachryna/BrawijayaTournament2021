<template>
    <div>
        ...
        <div v-if="data" class="content__">
            <h2 class="h2">Form Pendaftaran Tim Mobile Legends SMA/MA</h2>
            <div class="info__">
...
<script>
import ModalPlayer from "../../components/user/ModalCreatePlayerSma";
import ModalEditPlayer from "../../components/user/ModalEditPlayerSma";
import ModalOfficial from "../../components/user/ModalOfficial";
import TableOfficials from "../../components/user/TableOfficials";
import ModalViewPlayer from "../../components/user/ModalViewPlayerSma";
...
export default {
    ...
    methods: {
        ...
        async getTeam() {
            var res = await this.callApi("get", "/client/competition?type=mlsma");
        ...
        async updateTeam() {
            var res = await this.callApi(
                "put",
                `/client/update_competition/${this.data.id}`,
                {

...
<link rel="stylesheet" href="{{asset('/frontend/about/bootstrap/css/bootstrap.css')}}">
...
<div class="main penjelasan">
    ...
    <div class="row row1">
        <div class="col-6">
            <img src="{{asset('/frontend/about/Image/Asset%202@4x%20(2).png')}}" alt="logo" class="gambar">

        </div>
        <div class="col-6 bagian2">
            <div class="garis1 ">
                <p class="font-weight-normal deskripsi">BRAWIJAYA TOURNAMENT merupakan acara kegiatan yang berkolaborasi
                    ...
                    perlombaan dalam bidang olah raga dan seni. BRAWIJAYA TOURNAMENT ini merupakan kegiatan perlombaan
